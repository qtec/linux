...
enum v4l2_mbus_pixelcode {
	...
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_LEGACY_RGBPP),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_LEGACY_RGB),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_LEGACY_MONO),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_LEGACY_RGGB),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_LEGACY_GRBG),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_LEGACY_GBRG),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_LEGACY_BGGR),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_COMPACT_MONO),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_COMPACT_RGGB),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_COMPACT_GRBG),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_COMPACT_GBRG),
	V4L2_MBUS_FROM_MEDIA_BUS_FMT(QTEC_COMPACT_BGGR),
